 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductRequest implements ArrayAccess
{
    ...
    {
        if ((strlen($sku) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling ProductRequest., must be smaller than or equal to 50.');
        }
        if ((strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling ProductRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setProductGroup($product_group)
    {
        if ((strlen($product_group) > 50)) {
            throw new \InvalidArgumentException('invalid length for $product_group when calling ProductRequest., must be smaller than or equal to 50.');
        }
        if ((strlen($product_group) < 1)) {
            throw new \InvalidArgumentException('invalid length for $product_group when calling ProductRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDepartment($department)
    {
        if ((strlen($department) > 50)) {
            throw new \InvalidArgumentException('invalid length for $department when calling ProductRequest., must be smaller than or equal to 50.');
        }
        if ((strlen($department) < 1)) {
            throw new \InvalidArgumentException('invalid length for $department when calling ProductRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setProductType($product_type)
    {
        if ((strlen($product_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $product_type when calling ProductRequest., must be smaller than or equal to 50.');
        }
        if ((strlen($product_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $product_type when calling ProductRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((strlen($brand) > 50)) {
            throw new \InvalidArgumentException('invalid length for $brand when calling ProductRequest., must be smaller than or equal to 50.');
        }
        if ((strlen($brand) < 1)) {
            throw new \InvalidArgumentException('invalid length for $brand when calling ProductRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductRequest., must be smaller than or equal to 50.');
        }
        if ((strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        if ((strlen($description) > 50)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ProductRequest., must be smaller than or equal to 50.');
        }
        if ((strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ProductRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((strlen($gender) > 50)) {
            throw new \InvalidArgumentException('invalid length for $gender when calling ProductRequest., must be smaller than or equal to 50.');
        }
        if ((strlen($gender) < 1)) {
            throw new \InvalidArgumentException('invalid length for $gender when calling ProductRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/Homem|Mulher|Unissex/", $gender))) {
            throw new \InvalidArgumentException("invalid value for $gender when calling ProductRequest., must conform to the pattern /Homem|Mulher|Unissex/.");
        }
    ...
    {
        if ((strlen($size) > 50)) {
            throw new \InvalidArgumentException('invalid length for $size when calling ProductRequest., must be smaller than or equal to 50.');
        }
        if ((strlen($size) < 1)) {
            throw new \InvalidArgumentException('invalid length for $size when calling ProductRequest., must be bigger than or equal to 1.');
        }
